...
* [*adder*.add](https://github.com/d3/d3-array/blob/v2.7.1/README.md#adder_add) - add a value to an adder.
* [*adder*.valueOf](https://github.com/d3/d3-array/blob/v2.7.1/README.md#adder_valueOf) - returns a double precision representation of an adder’s value.
...
* [*bisector*.center](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bisector_center) - binary search for a value in a sorted array.
* [*bisector*.left](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bisector_left) - bisectLeft, with the given comparator.
* [*bisector*.right](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bisector_right) - bisectRight, with the given comparator.
...
* [*bin*](https://github.com/d3/d3-array/blob/v2.7.1/README.md#_bin) - bins a given array of samples.
* [*bin*.value](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bin_value)- specify a value accessor for each sample.
* [*bin*.domain](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bin_domain) - specify the interval of observable values.
* [*bin*.thresholds](https://github.com/d3/d3-array/blob/v2.7.1/README.md#bin_thresholds) - specify how values are divided into bins.
